...
PATH_TO_FROZEN_GRAPH = PATH_TO_FROZEN_GRAPH = MODEL_NAME + '/frozen_inference_graph.pb'
# ラベルファイルのパス
# PATH_TO_LABELS = '../models/research/object_detection/data/mscoco_label_map.pbtxt'
PATH_TO_LABELS = MODEL_NAME + '/mscoco_label_map.pbtx'
...
if __name__ == '__main__':
    ...
    detect_result = detector.detect('tmp.jpg')
